...
@main.command(help="Generate contracts for SPC mainnet")
def mainnet():
    ...
    init_proposal_threshold = "5000 ether"
    init_quorum_numerator = "10"
    propose_start_threshold = "250_000_000 ether"
