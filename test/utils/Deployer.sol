...
import "./interface/ISPCValidatorSet.sol";
...
import "./interface/ISPCGovernor.sol";
import "./interface/IGovToken.sol";
import "./interface/ISPCTimelock.sol";
...
contract Deployer is Test {
    ...
    SPCValidatorSet public bscValidatorSet;
    ...
    SPCGovernor public governor;
    GovToken public govToken;
    SPCTimelock public timelock;
    ...
    constructor() {
        ...
        bscValidatorSet = SPCValidatorSet(VALIDATOR_CONTRACT_ADDR);
        ...
        governor = SPCGovernor(GOVERNOR_ADDR);
        vm.label(address(governor), "SPCGovernor");
        govToken = GovToken(GOV_TOKEN_ADDR);
        vm.label(address(govToken), "GovToken");
        timelock = SPCTimelock(TIMELOCK_ADDR);
        vm.label(address(timelock), "SPCTimelock");
        tokenRecoverPortal = TokenRecoverPortal(TOKEN_RECOVER_PORTAL_ADDR);
        vm.label(address(tokenRecoverPortal), "TokenRecoverPortal");

        // set the latest code
        bytes memory deployedCode = vm.getDeployedCode("SPCValidatorSet.sol:SPCValidatorSet");
        ...
        deployedCode = vm.getDeployedCode("SPCGovernor.sol:SPCGovernor");
        ...
        deployedCode = vm.getDeployedCode("SPCTimelock.sol:SPCTimelock");
